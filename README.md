...
The Lua component of the BLT which controls mod loading can be found in its own repository, [Payday-2-SuperBLT-Lua](https://gitlab.com/znixian/payday2-superblt).
